...
//            announcement += '. Selected item type: ' + getItemNameForAnnouncement(currentItem) + '.';
        ...
        function updateTreasureUI() {
			...
			if (currentItem == 'stairs') {
                stairConfigEl.style.display = 'flex';
				updateStairCellList();
			...
			if (currentItem == 'key') {
                keyConfigEl.style.display = 'flex';
                ...
                if (currentItem === 'empty') {
					...
					if(items[existingIdx]){
						...
						if (type == "treasure"){
							...
							villagerConfigEl.style.display = 'flex'; 
							myVillager = items[existingIdx].meta
							...
							stairsConfigEl.style.display = 'flex'; 
